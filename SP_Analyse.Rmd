...
### In der Folge: Für mehrere Gruppen die zwei wichtigsten Probleme sowie die als kompetenteste wahrgenommene Partei. 
...
a %>% datatable(colnames = c('Liste', 'Stimmen', 'Verteilzahl', 'Sitzzahl V1',
...
d3 %>% datatable(colnames = c("Jahr", "Gemeinde", "Anteil RG", "Beteiligung", "Ratio"))
